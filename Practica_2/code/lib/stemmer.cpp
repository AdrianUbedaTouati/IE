...
char * stemmerPorter::removeSpanishAccent (char word[])
{
    ...
    for(i=len; i>=0; i--) {
        const char* letra = reinterpret_cast<const char *>(word[i]);
        if ((letra=="à") || (letra=="á") || (letra=="â") || (letra=="ä")) {
            word[i] = 'a';
        }
        if ((letra=="ò") || (letra=="ó") || (letra=="ô") || (letra=="ö")) {
            word[i] = 'o';
        }
        if ((letra=="è") || (letra=="é") || (letra=="ê") || (letra=="ë")) {
            word[i] = 'e';
        }
        if ((letra=="ù") || (letra=="ú") || (letra=="û") || (letra=="ü")) {
            word[i] = 'u';
        }
        if ((letra=="ì") || (letra=="í") || (letra=="î") || (letra=="ï")) {
            word[i] = 'i';
        }
    }
    return(word);
