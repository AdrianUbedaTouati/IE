#ifndef _TOKENIZADOR_H
#define _TOKENIZADOR_H
...
class Tokenizador {
    ...
    private:
            ...
            unsigned char equivalenteLetra[256]; // array para facilitar normalización

            string FusionarDelimitadores(const string &str1, const string &str2) const ;


            string NormalizarTexto(const string &str) const;

            void declararEquivalentes();
    ...
    public:
        ...
        void Tokenizar (const string& strP, list<string>& tokens) const;
